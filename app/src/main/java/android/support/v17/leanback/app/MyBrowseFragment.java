...
public class MyBrowseFragment extends BaseFragment {
    ...
    static final String TAG = "MyBrowseFragment";
    ...
    private static final String ARG_TITLE = MyBrowseFragment.class.getCanonicalName() + ".title";
    private static final String ARG_HEADERS_STATE =
            MyBrowseFragment.class.getCanonicalName() + ".headersState";
    ...
    private class ExpandPreLayout implements ViewTreeObserver.OnPreDrawListener {
        ...
        public boolean onPreDraw() {
            if (getView() == null || FragmentUtil.getContext(MyBrowseFragment.this) == null) {
